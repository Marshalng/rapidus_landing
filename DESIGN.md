...
- Audience and cadence: People moving money across currencies; quick, confident, and trust-oriented.
- Visual world (name + the feeling it creates): Emerald fintech command center — calm, modern, and quietly premium.
- Palette family + neutral undertone: Deep blue-green foundation with mint-teal action color, white type, and cool neutral surfaces.
- Type treatment: Tight geometric sans hierarchy with bold display headlines and compact medium-weight navigation.
- Composition: Centered hero narrative with generous breathing room, a faint vertical grid, and an oversized layered product preview anchored below.
- Shape language: Soft pills, restrained radii, crisp borders, and circular action affordances.
- Anti-references (defaults this app must not drift toward): Generic purple SaaS gradients, glassmorphism, noisy dashboards, dense explanatory copy, and playful consumer banking illustrations.
